...
- **شكل اللوجو:** حرف T كبير بأحمر تميم + كلمة TAMEM بالرمادي + كلمة "تميم" بالعربي بتدرّج برتقالي/ذهبي + DELIVERY بالرمادي
- **الملف المرجعي:** [docs/brand/logo.jpg](brand/logo.jpg)
- **النسخ الجاهزة (تم توليدها):**
  - Mobile (Expo): `apps/mobile/src/assets/logo.jpg` + `icon.png` (1024×1024) + `adaptive-icon.png` + `splash.png` (1242×2436)
  - Dashboard: `apps/dashboard/public/logo.png` + `favicon.png`
  - Landing: `apps/landing/public/logo.png` + `favicon.png` + `og-image.png` (1200×630)
- **سكربت إعادة التوليد:** `cd apps/backend && node scripts/generate-logo-variants.mjs`
- **الحجم الأدنى:** اللوجو الكامل ≥ 100×100px للوضوح
- **مسافة آمنة (safe area):** على الأقل 20% من ارتفاع اللوجو حوله
- **خلفيات مسموحة:** أبيض (الافتراضي - يبرز اللوجو)، فاتحة جداً
- **خلفيات ممنوعة:** ألوان تميم نفسها (الأحمر/البرتقالي) - تخفي اللوجو
- **ممنوع:** تشويه النسب، إضافة ظل ثقيل، تغيير ألوان اللوجو، استبدال اللوجو بحرف "ت" مجرد في الكود
