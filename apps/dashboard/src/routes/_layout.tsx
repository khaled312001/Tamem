...
const NAV_SECTIONS: NavSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { to: '/product-sections', icon: LayoutList, label: 'أقسام المنتجات', perm: 'products' },
      { to: '/deals', icon: Percent, label: 'عروض اليوم', perm: 'products' },
      { to: '/products/import-history', icon: History, label: 'سجل الاستيراد', perm: 'products' },
