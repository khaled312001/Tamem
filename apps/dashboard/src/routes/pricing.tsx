...
import { CardSkeleton, EmptyState, TableSkeleton } from '../components/ui/Skeleton.js';
  ...
  return (
    <div className="space-y-4">
      <div>
        ...
        <p className="text-sm text-muted-foreground mt-1">إدارة قواعد التسعير ومناطق التوصيل</p>
      </div>
      ...
      <div className="inline-flex items-center gap-1 rounded-xl border border-border bg-white p-1">
        ...
        <TabPill active={tab === 'zones'} onClick={() => setTab('zones')}>
          مناطق التوصيل
        </TabPill>
      </div>

      {tab === 'rules' ? <PricingRulesTab /> : <DeliveryZonesTab />}
    </div>
  );
}
  ...
  return (
    <button
      ...
      className={cn(
        ...
        active ? 'bg-brand-red text-white shadow-sm' : 'text-muted-foreground hover:bg-muted',
      )}
    >
      {children}
    </button>
...
// ────────────────────────────────────────────────────────────────────────────
// Tab 1: Pricing rules (existing, unchanged behavior)
// ────────────────────────────────────────────────────────────────────────────
  ...
  return (
    <div className="space-y-4">
      <div className="flex items-center justify-between">
        <div>
          <h2 className="text-lg font-black text-brand-dark">قواعد التسعير</h2>
